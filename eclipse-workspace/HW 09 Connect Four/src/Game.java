...
public class Game implements Runnable {
    public void run() {
        ...
        final JLabel wins = new JLabel();
        status_panel.add(wins);

        // Main playing area
        final GameCourt court = new GameCourt(status,wins);
        ...
        save.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				court.saveGame("saved_board.txt","saved_moves.txt");
			}
        });
        ...
        load.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				court.loadGame("saved_board.txt","saved_moves.txt");
			}	
        });
